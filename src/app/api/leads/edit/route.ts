...
export async function PATCH(req: Request) {
    try {
        ...
        const { leadId, clinic_name, city, phone_number, lead_identity, next_action_date } = body;
        ...
        const updatedResult = await prisma.lead.update({
            ...
            data: {
                ...
                next_action_date: next_action_date !== undefined ? next_action_date : dbLead.next_action_date
            }
        });
