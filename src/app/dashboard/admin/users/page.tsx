...
import { Loader2, Users, ArrowLeft, Save, Plus, Link as LinkIcon, Check } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex justify-between items-center bg-white dark:bg-slate-900 p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">Create corporate teams, set operational roles, and assign users precisely.</p>
                    </div>
                    ...
                    <Card className="col-span-1 shadow-sm border-slate-200 dark:border-slate-800 h-fit">
                        ...
                        <CardContent className="pt-4 space-y-4">
                            <div className="space-y-2">
                                ...
                                // Disable spaces from crashing string handling
                                />
                            </div>
                            <Button
